...
@section('content')
    ...
    <div class="a-propos-conteiner">
        <div>
            ...
            <p class="font-red font-14">Chez Replay, notre mission est de faciliter la revente de jeux de société pour
                encourager une consommation plus responsable, circulaire et ludique !
