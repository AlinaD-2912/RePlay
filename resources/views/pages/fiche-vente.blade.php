...
@section('content')
    ...
    <div class="vente-jeu-conteiner">
        ...
        <ol class="font-red font-14">
            ...
            <li>
                Nous vous fournissons une estimation du prix de vente, si cela vous convient il vous suffit de valider
                la vente et de créer un compte ou de vous connecter
            </li>
            <li>
                Une fois la vente validée, nous vous ferons parvenir un bon de livraison par mail et dans votre compte,
                il vous suffit d’imprimer ce dernier et de déposer vos jeux en point relais. On se charge du reste !
            </li>
        </ol>
    ...
    <div class="a-propos-conteiner font-red font-14">
        <p>Chaque jeu mis en vente sur Replay est vérifié avec soin par notre équipe. Grâce à notre Programme Qualité,
            nous vous garantissons des jeux complets, fonctionnels et classés selon leur état général.
